...
bool process_scan(const char* format, int* i, char** str, const int read,
                  int* counter, va_list* params, specs* format_modifiers);
bool set_c(char** str, int* counter, va_list* params, specs* format_modifiers,
           bool before_percent);
...
bool set_uox(const char specifier, char** str, int* counter, va_list* params,
             specs* format_modifiers);
bool set_s(char** str, int* counter, va_list* params, specs* format_modifiers);
bool set_p(char** str, int* counter, va_list* params, specs* format_modifiers);
